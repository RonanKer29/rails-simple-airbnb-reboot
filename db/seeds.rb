...
Flat.create!(
  name: 'Charming Studio in the Heart of Paris',
...
Flat.create!(
  name: 'Central Apartment in Tokyo',
...
Flat.create!(
  name: 'Urban Retreat in San Francisco',
...
Flat.create!(
  name: 'Historic Home in Edinburgh',
...
Flat.create!(
  name: 'Eco-Friendly Home in Reykjavik',
...
Flat.create!(
  name: 'Boutique Apartment in Lisbon',
...
Flat.create!(
  name: 'Luxurious Chalet in the Alps',
...
Flat.create!(
  name: 'Coastal Retreat in Cape Town',
